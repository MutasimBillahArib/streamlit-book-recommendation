...
def load_data_and_model():
    ...
    GITHUB_RAW_URL = "https://raw.githubusercontent.com/MutasimBillahArib/machine-learning-with-python-freecodecamp/main/book_recommendation_data.pkl"
...
def main():
    ...
    try:
        ...
        st.info("This may happen if the dataset is too large for Streamlit Community Cloud's free tier.")
